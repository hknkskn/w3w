            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    ...
                    <p className="text-slate-400 text-sm mt-1 uppercase tracking-widest font-bold">
                        Decentralized Media & Intelligence Network
                    </p>
                </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
                ...
                <div className="lg:col-span-1 space-y-6">
                    ...
                    <div className="bg-slate-900/40 border border-slate-800/50 rounded-xl p-4 shadow-lg">
                        <h3 className="text-[10px] font-black text-slate-500 uppercase tracking-[0.2em] mb-3">Network Status</h3>
                        <div className="space-y-3">
                            ...
                            <div className="flex justify-between items-center text-xs">
                                <span className="text-slate-400">Active Papers</span>
                                <span className="text-white font-mono">1,120</span>
                            </div>
                            <div className="flex justify-between items-center text-xs">
                                <span className="text-slate-400">CC Flow</span>
                    ...
                    <div className="p-4 bg-cyan-500/5 border border-cyan-500/10 rounded-xl flex items-center gap-3">
                        ...
                        <span className="text-[10px] font-bold text-cyan-400 uppercase tracking-wider">Tactical Update Pending</span>
                    </div>
                </div>
                ...
                <div className="lg:col-span-3 space-y-4">
                    ...
                    <div className="flex items-center gap-2 mb-2">
                        ...
                        <h2 className="text-xs font-black text-white uppercase tracking-widest italic">Mission Critical Intelligence</h2>
                            ...
                            >
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div className="flex flex-col items-center gap-2">
                                        <div className="w-12 h-12 bg-slate-950 rounded-lg border border-slate-800 overflow-hidden shadow-inner flex-shrink-0">
                                            <img
                                    ...
                                    <div className="flex-1 min-w-0">
                                        ...
                                        <p className="text-sm text-slate-500 mt-2 line-clamp-2 leading-relaxed italic">
                                            Operational reports indicate a massive surge in front-line activity...
                                        </p>
